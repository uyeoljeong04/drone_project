"""
spartina_flat.launch.py — [Phase3 측정] 평판 목표 버전 (높이 편향 제거)
=========================================================
기반: spartina_nav2.launch.py (기존 파일은 손대지 않음)

바뀐 점 딱 2가지:
  1. world : spartina_world.world → spartina_world_flat.world
...
def generate_launch_description():
    ...
    # ★ 변경점 1: 이동 버전 world
    world = os.path.join(project_dir, 'worlds', 'spartina_world_flat.world')
